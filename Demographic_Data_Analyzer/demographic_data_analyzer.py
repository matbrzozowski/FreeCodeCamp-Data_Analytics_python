...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = round(((len(min_workers[min_workers['salary'] == '>50K']) / num_min_workers) * 100), 1) 
    ...
    india_50K = india[india['salary'] == '>50K']
    india_50K_occupation = india_50K['occupation'].value_counts()

    top_IN_occupation = (india_50K_occupation).idxmax()
